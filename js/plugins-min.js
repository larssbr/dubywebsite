    ...
    p = {
        ...
        n.Pipe = [{
            ...
            run: function() {
                ...
                if (this.$stage.css(n),
                    ...
                    for (e = 0,
                        i = this._coordinates.length; i > e; e++) n.width = Math.abs(this._coordinates[e]) - Math.abs(this._coordinates[e - 1] || 0) - this.settings.margin,
        ...
        n.prototype.setup = function() {
            ...
            i ? (t.each(i, function(t) {
                ...
                n = t.extend({},
                    ...
                    i[s]),
                delete n.responsive,
                n.responsiveClass && this.$element.attr("class",
                    function(t,
                        e) {
                        return e.replace(/\b owl-responsive-\S+/g, "")
                    }
                ).addClass("owl-responsive-" + s)) : n = t.extend({},
                this.options), (null === this.settings || this._breakpoint !== s) && (this.trigger("change", {
                    property: {
                        name: "settings",
                        value: n
                    }
        ...
        n.prototype.update = function() {
            for (var e = 0, i = this._pipe.length, s = t.proxy(function(t) {
                        ...
                        this._invalidated),
                    n = {}; i > e;)(this._invalidated.all || t.grep(this._pipe[e].filter,
                    s).length > 0) && this._pipe[e].run(n),
                e++;
            this._invalidated = {}
        },
        ...
        n.prototype.internalEvents = function() {
            ...
            this.settings.mouseDrag ? (this.$stage.on("mousedown", t.proxy(function(t) {
                ...
                this.settings.touchDrag && !i && this.$stage.on("touchstart touchcancel",
                    t.proxy(function(t) {
                            this.eventsRouter(t)
                        },
                        this)),
                ...
                this.settings.responsive !== !1 && this.on(e,
                    "resize",
                    t.proxy(this.onThrottledResize,
                        this))
        },
        ...
        n.prototype.closest = function(e) {
            ...
            return this.settings.freeDrag || t.each(o, t.proxy(function(t, r) {
                    ...
                    this)),
                this.settings.loop || (this.op(e,
                    ">",
                    o[this.minimum()]) ? i = e = this.minimum() : this.op(e,
                    "<",
                    o[this.maximum()]) && (i = e = this.maximum())),
                i
        },
        ...
        n.prototype.add = function(t,
            ...
            e = e === s ? this._items.length : this.normalize(e, !0), this.trigger("add", {
                ...
                0 === this._items.length || e === this._items.length ? (this.$stage.append(t),
                    ...
                    this._items.splice(e,
                        0,
                        t),
                    this._mergers.splice(e,
                        0,
                        1 * t.find("[data-merge]").andSelf("[data-merge]").attr("data-merge") || 1)),
                this.invalidate("items"),
                this.trigger("added", {
                    content: t,
                    position: e
        ...
        n.prototype.remove = function(t) {
            t = this.normalize(t, !0), t !== s && (this.trigger("remove", {
                ...
                this._items.splice(t,
                    1),
                this._mergers.splice(t,
                    1),
                this.invalidate("items"),
        ...
        n.prototype.watchVisibility = function() {
            ...
            i(this.$element.get(0)) || (this.$element.addClass("owl-hidden"),
                ...
                this.e._checkVisibile = e.setInterval(t.proxy(s,
                        this),
                    500))
        },
        ...
        n.prototype.trigger = function(e,
            ...
            return this._supress[e] || (t.each(this._plugins,
                    ...
                    this.settings && "function" == typeof this.settings[o] && this.settings[o].apply(this,
                        r)),
                r
        },
                ...
                "initialized.owl.carousel change.owl.carousel": t.proxy(function(e) {
                        if (e.namespace && this._core.settings && this._core.settings.lazyLoad && (e.property && "position" == e.property.name || "initialized" == e.type))
                            for (var i = this._core.settings, s = i.center && Math.ceil(i.items / 2) || i.items, n = i.center && -1 * s || 0, o = (e.property && e.property.value || this._core.current()) + n, r = this._core.clones().length, a = t.proxy(function(t, e) {
                                ...
                                r && t.each(this._core.clones(this._core.relative(o++)),
                                    a)
                    },
                    this)
            },
...
function(t,
    ...
    s.Defaults = {
        ...
        s.prototype.thumbnail = function(e,
            i) {
            ...
            return e.wrap('<div class="owl-video-wrapper"' + r + "></div>"),
                this._core.settings.lazyLoad && (h = "data-src",
                    l = "owl-lazy"),
                a.length ? (d(a.attr(h)),
                    a.remove(), !1) : void("youtube" === i.type ? (o = "http://img.youtube.com/vi/" + i.id + "/hqdefault.jpg",
    ...
    var s = function(e) {
        this.core = e, this.core.options = t.extend({}, s.Defaults, this.core.options), this.handlers = {
                "translated.owl.carousel refreshed.owl.carousel": t.proxy(function() {
                    ...
                    this),
                "play.owl.autoplay": t.proxy(function(t,
                        e,
                        i) {
                        this.play(e, i)
                    },
    ...
    s.Defaults = {
        ...
        s.prototype.autoplay = function() {
            this.core.settings.autoplay && !this.core.state.videoPlay ? (e.clearInterval(this.interval), this.interval = e.setInterval(t.proxy(function() {
                    ...
                    this),
                this.core.settings.autoplayTimeout)) : e.clearInterval(this.interval)
        },
    ...
    e.Defaults = {
        ...
        e.prototype.initialize = function() {
            ...
            s.dotsData || (this._templates = [t("<div>").addClass(s.dotClass).append(t("<span>")).prop("outerHTML")]), s.navContainer && s.dotsContainer || (this._controls.$container = t("<div>").addClass(s.controlsClass).appendTo(this.$element)), this._controls.$indicators = s.dotsContainer ? t(s.dotsContainer) : t("<div>").hide().addClass(s.dotsClass).appendTo(this._controls.$container), this._controls.$indicators.on("click", "div", t.proxy(function(e) {
                ...
                this._controls.$previous.addClass(s.navClass[0]).html(s.navText[0]).hide().prependTo(e).on("click",
                    t.proxy(function() {
                            this.prev(s.navSpeed)
                        },
                        this)),
                this._controls.$next.addClass(s.navClass[1]).html(s.navText[1]).hide().appendTo(e).on("click",
                    t.proxy(function() {
                            this.next(s.navSpeed)
                        },
                        this));
            for (i in this._overrides) this._core[i] = t.proxy(this[i],
                this)
        },
        e.prototype.destroy = function() {
            var t, e, i, s;
        ...
        e.prototype.draw = function() {
            ...
            if (!n.nav || n.loop || n.navRewind || (this._controls.$previous.toggleClass("disabled", 0 >= o), this._controls.$next.toggleClass("disabled", o >= this._core.maximum())), this._controls.$previous.toggle(n.nav), this._controls.$next.toggle(n.nav), n.dots) {
                ...
                } else e > 0 ? (s = new Array(e + 1).join(this._templates[0]),
                    this._controls.$indicators.append(s)) : 0 > e && this._controls.$indicators.children().slice(e).remove();
                this._controls.$indicators.find(".active").removeClass("active"),
                    this._controls.$indicators.children().eq(t.inArray(this.current(),
    ...
    var i = function(s) {
        this._core = s, this._hashes = {}, this.$element = this._core.$element, this._handlers = {
            ...
            this._core.options = t.extend({},
                ...
                this._core.options),
            this.$element.on(this._handlers),
            t(e).on("hashchange.owl.navigation",
                t.proxy(function() {
